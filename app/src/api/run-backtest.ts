...
import { findStrategy } from "@temchik/bot-templates/server";
import { Backtesting } from "@temchik/backtesting";
import { CCXTCandlesProvider } from "@temchik/bot";
import { logger } from "@temchik/logger";
import { exchangeCodeMapCCXT } from "@temchik/exchanges";
import type { BarSize, ExchangeCode, ICandlestick } from "@temchik/types";
