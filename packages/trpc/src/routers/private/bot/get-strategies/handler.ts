...
import { BotTemplate } from "@temchik/bot-processor";
import { templates } from "@temchik/bot-templates";
import { customStrategies } from "@temchik/bot-templates/server";
...
function isZodObject(schema: any): schema is ZodObject<any> {
  ...
  // TODO: Maybe export the `z` instance to allow importing it as `import { z } from "temchik";`
