...
import type { IBotConfiguration, SmartTradeService, TBotContext } from "@temchik/bot-processor";
import { cancelSmartTrade, useExchange, useSmartTrade } from "@temchik/bot-processor";
import { computeGridLevelsFromCurrentAssetPrice, decomposeSymbol } from "@temchik/tools";
import { ZGridBotSettings, type IGetMarketPriceResponse } from "@temchik/types";
