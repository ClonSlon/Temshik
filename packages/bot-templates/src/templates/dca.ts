import { evaluateConditions, extractIndicators, IndicatorsValues, requiredHistory } from "@temchik/tools";
import { z } from "zod";
import { logger } from "@temchik/logger";
import { BarSize, ZDcaBotSettings } from "@temchik/types";
import {
  useDca,
  cancelSmartTrade,
  IBotConfiguration,
