import { z } from "zod";
import type { ISymbolInfo } from "@temchik/types";
import type { IExchange } from "@temchik/exchanges";
import type { IBotConfiguration, TBotContext } from "@temchik/bot-processor";
import { useExchange } from "@temchik/bot-processor";
