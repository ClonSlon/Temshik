 ...
 *
 * Repository URL: https://github.com/bludnic/temchik
 */
import type { IBotConfiguration, StrategyRunner, BotTemplate, BotState } from "@temchik/bot-processor";
import { createStrategyRunner } from "@temchik/bot-processor";
import type { ICandlestick } from "@temchik/types";
import { logger, format } from "@temchik/logger";
