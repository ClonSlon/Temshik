...
import type { BotTemplate, IBotConfiguration, Order, Trade } from "@temchik/bot-processor";
import { ICandlestick, XOrderStatus } from "@temchik/types";
import { format } from "@temchik/logger";
import { decomposeSymbol } from "@temchik/tools";
