import { type ExchangeAccountWithCredentials, xprisma } from "@temchik/db";
import type { SmartTradeWithOrders } from "@temchik/db";
import { exchangeProvider, type IExchange } from "@temchik/exchanges";
import { logger } from "@temchik/logger";
import { ITicker, XEntityType, XOrderStatus, XOrderType } from "@temchik/types";
